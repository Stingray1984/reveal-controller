...
var presentation = io.on('connection', function (socket) {
	...
	socket.on('slide-changed', function(data){
		...
		if(data.key === secret) {
			...
			console.log("Received Data Hash: ", data.hash);
	...
	// Mobile device sent a navigation direction
	socket.on('send-mobile-nav', function(data){
		if(data.key === secret) {
			console.log("Received Mobile Nav Direction: ", data.direction);

			presentation.emit('mobile-nav', {
